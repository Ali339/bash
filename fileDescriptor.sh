#!/bin/bash
#It is the same script with extra functionality
# user of the script does not want to see the stdout on screen 
#we can fullfill the above requirement using the file descriptors 
